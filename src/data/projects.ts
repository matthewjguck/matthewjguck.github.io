...
export const projects = [
  {
    id: "inklings",
    title: "Inklings",
    description: "A network of receipt printers across Stanford's campus paired with a web app for sending physical, paper messages over the internet. Winner of the Robert H. McKim Award. ",
    image: "/images/inklings/inklings-splash.png",
    tags: ["Product Design", "Hardware", "React", "Supabase", "IoT"],
    liveUrlLabel: "",
    date: "Spring 2026",
    type: "Stanford d.school Capstone",
    location: "Stanford, CA",
    role: "Designer, Developer",
    status: "🏆 Best Capstone",
    content: "",
    layoutKey: "inklings" as LayoutKey,
    features: [
      "Compose an Inkling and address it to any Stanford SUNet ID",
      "Prints as a surprise on a campus-wide network of receipt printers",
      "Supports text, images, and hand-drawn stickers",
      "Custom Raspberry Pi print server with a bespoke USB driver",
    ],
    technologies: ["React", "Supabase", "Raspberry Pi", "Python", "Resend", "Wix", "Porkbun"],
    outcome: "Awarded the Robert H. McKim Award, recognizing outstanding design work from a Stanford d.school capstone team. Grew to 326 users who sent 641 Inklings, with 68% of senders returning to send more than one.",
  },
  {
    id: "cupid",
    title: "The Cupid Project",
    description: "An 501(c)(3) Non-profit card-giving project delivering to nursing homes every Valentine's Day since 2018.",
