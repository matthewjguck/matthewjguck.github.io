...
interface BuildTextCanvasProps {
...
const buildTextCanvas = ({ container, width, height, dpr, props }: BuildTextCanvasProps): HTMLCanvasElement => {
...
const WarpText = ({
  ...
  useEffect(() => {
    ...
    mediaQuery?.addEventListener('change', onReducedMotion as EventListener);
    ...
    return () => {
      ...
      mediaQuery?.removeEventListener('change', onReducedMotion as EventListener);
