...
const resolveCharset = (charset: string | keyof typeof CHARSETS) => {
...
interface SplitFlapTextProps {
  ...
  stagger?: number;
  cycleDelay?: number;
  charset?: string | keyof typeof CHARSETS;
  flipsPerChar?: number;
  tileColor?: string;
  textColor?: string;
...
const SplitFlapText = ({
  ...
  useEffect(() => {
    ...
    const activeCharset = resolveCharset(charset as string | keyof typeof CHARSETS);
